...
class Movement_Shortcode_Map_Last100hours_Goals
{
    public $namespace = 'movement_maps_stats/v1/';
    public $token = 'last100hours_map_goal';
    public $ip_response;
...
Movement_Shortcode_Map_Last100hours_Goals::instance();
